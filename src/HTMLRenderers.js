...
export function item(htmlAttribs, children, convertedCSSStyles, passProps) {
    const style = _constructStyles({
        tagName: 'item',
        htmlAttribs,
        passProps
...
export function subscribe (htmlAttribs, children, convertedCSSStyles, passProps) {
    const style = _constructStyles({
        tagName: 'subscribe',
        htmlAttribs,
        passProps
    ...
    const { onBuyPress } = passProps;
    const onPress = () => onBuyPress ?
        onBuyPress() :
        undefined;
    // const onPress = () => onBuyPress();
    
    return (
        <Text {...passProps} onPress={onPress} style={style}>
            {children}
        </Text>
    );
}
